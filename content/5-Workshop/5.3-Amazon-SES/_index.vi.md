...
3. Chọn Identity type là **Email address**. Tại trường dữ liệu, tiến hành nhập địa chỉ **admin.vdcms@gmail.com** rồi nhấn nút **Create Identity** ở góc dưới. Trạng thái ban đầu của Identity này sẽ hiển thị là **Verification pending** (Chờ xác thực).
