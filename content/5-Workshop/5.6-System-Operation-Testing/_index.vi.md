...
* **Kiểm thử tích hợp luồng Voice Transcribe:**
  ...
  2. Kỹ sư bắt đầu đọc nội dung báo cáo thực địa (Ví dụ: *"Hello, hello, hello"*).

  3. Quay lại giao diện ứng dụng, đoạn mã văn bản đã dịch tự động bởi dịch vụ **Amazon Transcribe** xuất hiện đầy đủ và chính xác trong nội dung báo cáo mà không cần nhập liệu thủ công.
